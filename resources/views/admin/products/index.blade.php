        ...
        <div class="grid grid-cols-12 border-b border-gray-200 p-4 text-sm gap-2">
          ...
          <div class="col-span-2">
            <div class=" flex gap-2 justify-end">
              ...
              <a href="{{ route('products.show', $product) }}" target="_blank" class="border border-green-200 bg-green-100 p-2 rounded-full text-green-400 hover:bg-green-400 hover:text-white hover:border-green-400 transition-all">
