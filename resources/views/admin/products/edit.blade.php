<x-layouts.admin :title="$product->name">
  ...
  <form 
    ...
    <h1 class="font-semibold text-lg text-gray-800">Update Product</h1>
      ...
      <div class="col-span-2 flex flex-col gap-4">
          ...
          <div class="px-4 py-5 text-gray-800">
            ...
            <div class="mt-4">
              ...
              <select class="simple-input-1 mt-2" required="" name="category_id">
                ...
                <option value="{{ $category->id }}" {{ old('category_id') == $category->id || $product->category_id == $category->id ? 'selected':'' }}>{{ $category->name}}</option>
                @endforeach
              </select>
            </div>

            <div class="mt-4" x-data="{hasLimit: @json(old('max_order') || $product->max_order ?true:false)}">
        ...
        <div class="bg-white shadow-lg rounded">
          ...
          <div class="px-4 py-5 text-gray-800" x-data="tinymce('#productDescription')">
            ...
            <textarea name="description" id="productDescription" x-cloak>{{ old('description') ?? $product->description }}</textarea>
          </div>
        </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="bg-white rounded shadow-lg">
          ...
          <div class="px-4 py-5 grid grid-cols-2">
            ...
            <x-input.switch name="is_featured" :checked="old('is_featured') || $product->is_featured"/>
