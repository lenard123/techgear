<x-layouts.admin title="Most favorite Products by Customers">
  <div class="p-4">
    <div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded mt-8">
      <div class="p-4 border-b border-gray-200">
        <span class="font-semibold text-lg text-gray-800">Most favorite Products by Customers</span>
      </div>
        ...
        <table class="border border-gray-200 w-full text-sm text-gray-800">
          <thead>
            <tr>
              ...
              <th class="p-2 border" width="10%">No. of Users</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="border p-2 text-center">{{ $product->favorites_count }}</td>
            </tr>
            @endforeach
          </tbody>
        </table>
