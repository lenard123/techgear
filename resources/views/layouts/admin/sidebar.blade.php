<aside 
  ...
  <nav>
    ...
    <ul>
      <li>
        <a href="{{ route('admin.home') }}" class="flex hover:bg-gray-700 text-gray-300 py-2">
    ...
    <ul>
      <li>
        <a href="{{ route('admin.categories.index') }}" class="flex hover:bg-gray-700 text-gray-300 py-2">
          <span class="inline-flex justify-center items-center w-12 h-6 flex-none">
      ...
      <li>
        <a href="{{ route('admin.products.index') }}" class="flex justify-between hover:bg-gray-700 text-gray-300 py-2">
      ...
      <li>
        <a href="{{ route('admin.orders.index') }}" class="flex justify-between hover:bg-gray-700 text-gray-300 py-2">
          <div class="flex items-center">
            <span class="inline-flex justify-center items-center w-12 h-6 flex-none">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
