<footer class="bg-gray-800 text-gray-400 p-5">  
  ...
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-y-5">
    ...
    <div>
      ...
      <!-- Brand name and Logo -->
      <a
        class="flex justify-center sm:justify-start font-iceland"
        href="{{ route('home') }}"
        >
        <img
    ...
    <div>
      ...
      <a 
        href="#" 
        title="Twitter" 
        class="rounded-full text-coolGray-50 flex content-start"
        >
    ...
    <div>
      ...
      <h3 class="tracking-wide uppercase text-white">Site Links</h3>
